...
import 'createaccount2_model.dart';
export 'createaccount2_model.dart';
...
class _Createaccount2WidgetState extends State<Createaccount2Widget> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: const Color(0xEBE3E9E0),
        body: SafeArea(
          top: true,
          child: Row(
                                  ...
                                  children: [
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 12.0, 0.0, 24.0),
                                      child: Text(
                                        'Bonjour!\nVeuillez vous connecter à Tradipharma',
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            filled: true,
                                            fillColor: const Color(0x53B1E1AC),
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
