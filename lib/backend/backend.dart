...
/// Functions to query DiseasesRecords (as a Stream and as a Future).
Future<int> queryDiseasesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DiseasesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DiseasesRecord>> queryDiseasesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DiseasesRecord.collection,
      DiseasesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DiseasesRecord>> queryDiseasesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query PlantRecognitionResultsRecords (as a Stream and as a Future).
Future<int> queryPlantRecognitionResultsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PlantRecognitionResultsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PlantRecognitionResultsRecord>> queryPlantRecognitionResultsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PlantRecognitionResultsRecord.collection,
      PlantRecognitionResultsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PlantRecognitionResultsRecord>>
    queryPlantRecognitionResultsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
